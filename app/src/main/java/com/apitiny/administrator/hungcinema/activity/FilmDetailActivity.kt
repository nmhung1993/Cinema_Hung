    ...
    ApiProvider().callApiGetFilmDetail(object : ApiResult {
      ...
      override fun onModel(baseModel: BaseModel) {
        if (baseModel is FilmDetailModel) {
          ...
          Glide.with(this@FilmDetailActivity).load("https://cinema-hatin.herokuapp.com" + _posterURL).apply(RequestOptions().placeholder(R.drawable.ic_defaultmv)).into(imgFilm)
