...
import com.apitiny.administrator.cinema_hung.di.component.DaggerFragmentComponent
...
import com.apitiny.administrator.cinema_hung.util.SwipeToDelete
...
class ListFragment: Fragment(), ListContract.View, ListAdapter.onItemClickListener {
    ...
    override fun loadDataSuccess(list: List<Post>) {
        //var adapter = ListAdapter(this.activity, list.toMutableList<Post>(), this)
